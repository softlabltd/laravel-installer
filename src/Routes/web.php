...
Route::group(['prefix' => 'install', 'as' => 'LaravelInstaller::', 'namespace' => 'Ffegu\LaravelInstaller\Controllers',
 'middleware' => ['web', 'install']], function () {
    ...
    // Route::get('site-configuration', [
    //     'as' => 'siteConfiguration',
    //     'uses' => 'AiomlmController@siteConfiguration',
    // ]);
    // Route::get('site-configuration/save', [
    //     'as' => 'saveSiteConfiguration',
    //     'uses' => 'AiomlmController@saveSiteConfiguration',
    // ]);
    // Route::get('site-finised', [
    //     'as' => 'siteFinished',
    //     'uses' => 'AiomlmController@siteFinished',
    // ]);
});

Route::group(['prefix' => 'update', 'as' => 'LaravelUpdater::', 'namespace' => 'Ffegu\LaravelInstaller\Controllers', 'middleware' => 'web'], function () {
