...
@section('template_title')
    {{ trans('installer_messages.site.title') }}
@endsection
...
@section('container')
    <div class="tabs tabs-full">
        ...
        <label for="tab1" class="tab-label">
            ...
            <br />
            {{ trans('installer_messages.site.settings') }}
        </label>
        ...
        <label for="tab2" class="tab-label">
            ...
            <br />
            {{ trans('installer_messages.site.admin') }}
        </label>
        ...
        <label for="tab3" class="tab-label">
            <i class="fa fa-user fa-2x fa-fw" aria-hidden="true"></i>
            <br />
            {{ trans('installer_messages.site.master') }}
        </label>

        <form method="post" action="{{ route('LaravelInstaller::saveSiteConfiguration') }}" class="tabs-wrap">
            <div class="tab" id="tab1content">
                ...
                <div class="form-group {{ $errors->has('admin_email') ? ' has-error ' : '' }}">
                    ...
                    <input type="email" name="admin_email" id="admin_email" value=""
                     placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
                ...
                <div class="form-group {{ $errors->has('admin_password_confirmation') ? ' has-error ' : '' }}">
                    ...
                    <input type="text" name="admin_password_confirmation" id="admin_password_confirmation" value=""
                     placeholder="{{ trans('installer_messages.environment.wizard.form.app_name_placeholder') }}" />
